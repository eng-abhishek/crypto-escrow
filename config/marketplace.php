...
return [
    ...
    /**
     * If registration is enabled or disabled
     */

    'registration_enabled' => boolval(env('MARKETPLACE_REGISTRATION_ENABLED',true)),
     ...
     */
    'days_complete' => intval(env("DAYS_TO_COMPLETE_PURCHASE", 1)),

    /**
     * Messages that are older than this number of days are deleted
     */
    'days_old_messages' => intval(env("MESSAGES_DAYS_OLD", 7)),
    ...
    'mirrors' => [
        [
            'key' => 'random_unique_string',
            'url' => 'http://marketplace.test/',
            'signed_message' => 'This is a signed message from marketplace pgp key'
        ]
