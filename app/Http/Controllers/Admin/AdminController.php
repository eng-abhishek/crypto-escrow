...
class AdminController extends Controller
{
    ...
    private function announcementsCheck(){
        if(Gate::denies('has-access', 'announcements'))
            abort(403);
    }
    ...
    {
        //  $a = Dispute::paginate(config('marketplace.products_per_page'));
    ...
    /**
     * List of feature prouduct purchases
     *
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function featurePurchases()
    {
        return view('admin.featurepurchases', [
            'vendors' => Vendor::orderByDesc('created_at')->paginate(24),
        ]);
    }
