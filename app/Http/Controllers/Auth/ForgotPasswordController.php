...
class ForgotPasswordController extends Controller
{
    public function showForget(){
        return view('frontend.auth.forgotpassword.forgotpassword');
    }

    public function showMnemonic(){
        return view('frontend.auth.forgotpassword.mnemonicpassword');
    }

    public function showPGP(){
        return view('frontend.auth.forgotpassword.pgppassword');
    }
