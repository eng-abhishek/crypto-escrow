...
class ProductController extends Controller
{
    ...
    public function show(Product $product) {
        ...
        $product_reviews = Feedback::with('buyer')->where('product_id',$product->id)->take(1)->orderBy('id','desc');
        $reviews = $product_reviews->first();      
...
/*--------- Product Reviews ---------*/
 ...
 public function productReviews(Product $product){
   ...
   $product_reviews = Feedback::with('buyer')->where('product_id',$product->id)->orderBy('id','desc')->get();
