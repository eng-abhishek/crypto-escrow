...
class RecoverPasswordPgpRequest extends FormRequest
{
    ...
    public function persist(){
        ...
        //$validationNumber = Config('app.name')."_Forgot_passwod_PGP_".rand(100000000000, 999999999999); 

        // Radnom number to confirm
       
        $validationNumber = Config('app.name')."_PGP_".rand(1000, 9999); // Radnom number to confirm
